var game =
{
	answer : Math.ceil(Math.random() * 99), // random number from 1 to 99
	tries : 7,
	
	init : function()
	{
		console.log("Random Number = " + this.answer);// for debugging
		// purposes
	...
	regenerateNumber : function()
	{
		...
		console.log("New Random Number = " + this.answer);// for debugging
		// purposes
	},
	...
	{
		console.log(value + " clicked.");// for debugging purposes
		
		var userValueEle = document.getElementById("userValue");
		
		if (value == "0" && userValueEle.value == "")
		{
			// if first number entering is 0 the program is doing nothing
		}
		else
		{
	...
	checkAnswer : function()
	{
		...
		else if (userValueEle.value > this.answer)
		{
			...
			{
				alert("Guessing number is more than the correct number, " + this.tries + " tries has left");
				userValueEle.value = "";
			}
		}
		...
		else
		{
			...
			{
				alert("Guessing number is less than the correct number, " + this.tries + " tries has left ");
				userValueEle.value = "";
			}
		}
	},
